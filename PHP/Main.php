...
if($opt == 2 || $opt == 3) {
    echo '<form action="main.php" method="post" enctype="multipart/form-data">';
        if ($opt == 2) {
            ...
            // NIK
            echo '<label for="nik">Masukkan NIK mahasiswa             : </label><br>';
            echo '<input type="text" name="nik", id="nik"><br>';
            // NIM
            echo '<label for="nim">Masukkan NIM mahasiswa             : </label><br>';
            echo '<input type="text" name="nim", id="nim"><br>';
            // Nama
            echo '<label for="nama">Masukkan Nama mahasiswa            : </label><br>';
            echo '<input type="text" name="nama" id="nama"><br>';
            // Jenis_kelamin
            echo '<label for="jenis_kelamin">Masukkan Jenis_kelamin mahasiswa   : </label><br>';
            echo '<input type="text" name="jenis_kelamin" id="jenis_kelamin"><br>';
            // E-mail
            echo '<label for="email_edu">Masukkan E-mail mahasiswa          : </label><br>';
            echo '<input type="text" name="email_edu", id="email_edu"><br>';
            // Prodi
            echo '<label for="prodi">Masukkan Program studi mahasiswa   : </label><br>';
            echo '<input type="text" name="prodi" id="prodi"><br>';
            // Fakultas
            echo '<label for="fakultas">Masukkan Fakultas mahasiswa        : </label><br>';
            echo '<input type="text" name="fakultas" id="fakultas"><br>';
            // Universitas
            echo '<label for="univ">Masukkan Universitas mahasiswa     : </label><br>';
...
if(isset($_POST['submitDelete'])) {
  ...
  if($n == 0){
    echo '<br><br>### ID is not found ###<br><br>';
  }
}
